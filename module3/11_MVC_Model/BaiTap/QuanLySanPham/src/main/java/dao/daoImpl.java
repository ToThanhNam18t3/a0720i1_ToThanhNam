...
public class daoImpl implements IProductDAO {
    private static final String INSERT_PRODUCT_SQL ="Insert into products(ID,NameProduct,Price,Image,idAuthor) value (?,?,?,?,?)";
    ...
    public void insertProduct(Product product) throws SQLException {
        ...
        preparedStatement.setInt(5, product.getIdAuthor());
    ...
    public List<Product> getAllProduct() throws SQLException {
        ...
        while (resultSet.next()){
            ...
            productList.add(new Product(ID,name,price,image,idAuthor));
        }
        return productList;
    }
