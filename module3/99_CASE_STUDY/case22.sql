...
-- của tất cả các nhân viên có địa chỉ là “Hải Châu” và đã từng lập hợp đồng cho 1 hoặc nhiều Khách hàng bất kỳ  với ngày lập hợp đồng là “12/12/2019”
...
UPDATE v_nhanvien set DiaChi = "Hải Châu" where IDNhanVien = 10005;
...
delimiter //
Create Procedure Sp_1 (IdKhachHang)
	BEGIN
