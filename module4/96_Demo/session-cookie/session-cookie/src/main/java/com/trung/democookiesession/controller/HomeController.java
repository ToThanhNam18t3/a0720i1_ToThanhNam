...
public class HomeController {
    ...
    public String createCookie(HttpServletResponse response, Model model) {
        Cookie cookie1 = new Cookie("userName", "TrungDoan1");
...
//        response.addCookie(cookie3);
    ...
    public String delete(@CookieValue(name = "userName")String userName, @CookieValue(name = "userName2")String userName2, HttpServletResponse response){
        Cookie cookie = new Cookie("userName", userName);
//        Cookie cookie2 = new Cookie("userName2", userName2);
        cookie.setMaxAge(0);
//        cookie2.setMaxAge(0);
        response.addCookie(cookie);
//        response.addCookie(cookie2);
